                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            type="time"
                            value="{{ $startTime }}"
                            class="mt-2 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm outline-none transition focus:border-slate-950 focus:ring-2 focus:ring-slate-950/10"
                            required
                        >
